 ...
 *
 */
public class ChineseCalendarTool {
    ...
    private static String[] SolarTerm = { "小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨", "立夏", "小满", "芒种", "夏至", "小暑", "大暑", "立秋", "处暑", "白露", "秋分",
            "寒露", "霜降", "立冬", "小雪", "大雪", "冬至" };
    ...
    final static long[] STermInfo = new long[] { 0, 21208, 42467, 63836, 85337, 107014, 128867, 150921, 173149, 195551, 218072, 240693, 263343,
     ...
     * @return
     */
    public ChineseCalendarTool(Calendar cal) {
    ...
    public static void main(String[] args) {
        ...
        today.setTime(date);
        ChineseCalendarTool lunar = new ChineseCalendarTool(today);
        String solarTerms = ChineseCalendarTool.getSolarTerms(
                today.get(Calendar.YEAR),
                today.get(Calendar.MONTH) + 1,
                today.get(Calendar.DAY_OF_MONTH));
        System.out.println("北京时间：" + chineseDateFormat.format(today.getTime()) + "　农历" + lunar + solarTerms);
