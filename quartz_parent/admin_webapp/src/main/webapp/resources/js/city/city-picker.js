        ...
        bind: function () {
            ...
            this.$dropdown.on('click', '.city-select a', function () {
                ...
                if ($active.data('code') !== $(this).data('code')) {
                    ...
                    $this.feedText();
                    $this.feedVal();
                    if($select.hasClass("province")){
                    	$("#city-province").val($(this).data('code'))
                    }
                    else if($select.hasClass("city")){
                    	$("#city-city").val($(this).data('code'))
                    }
                    else if($select.hasClass("district")){
                    	$("#city-district").val($(this).data('code'))
                    	$this.close();
                    }
//                  else if(last) {}
                }
